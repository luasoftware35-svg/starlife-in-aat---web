    ...
    <div className="bg-white text-ink min-h-screen">
      ...
      <section className="bg-white text-ink py-20 px-6 md:px-16">
        <motion.div variants={fadeUp} initial="hidden" whileInView="visible" viewport={{ once: true }} className="max-w-[900px] mx-auto text-center">
          ...
          <p className="text-ink/70 leading-relaxed mt-5">Misyonumuz, yüksek mühendislik standartları ve çağdaş tasarım anlayışıyla yaşam alanlarını yeniden şekillendirmek ve değer üreten projeler ortaya koymaktır. Güvenlik, kalite ve müşteri memnuniyeti ilkelerimizden ödün vermeden, doğaya ve şehre uyumlu yapılar inşa ederek, insanların yaşam kalitesini artırmayı amaçlıyoruz.</p>
        </motion.div>
      </section>
