          ...
          {posts.map((b) => (
            <motion.article key={b.id} variants={fadeUp} className="group">
              ...
              <div className="mt-5">
                ...
                <Link to={`/blog/${b.slug}`} className="inline-flex items-center gap-2 text-gold text-xs tracking-[0.3em] uppercase mt-5 border-b border-gold/40 pb-1 group-hover:gap-3 transition-all">
