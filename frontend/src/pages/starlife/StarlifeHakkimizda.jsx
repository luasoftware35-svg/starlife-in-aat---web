      ...
      <section className="bg-white text-ink py-24 px-6 md:px-16">
        <div className="max-w-[1400px] mx-auto grid lg:grid-cols-2 gap-16 items-center">
          <motion.div variants={fadeUp} initial="hidden" whileInView="visible" viewport={{ once: true }}>
            ...
            <p className="text-ink/70 leading-relaxed mt-6">Starlife İnşaat, Numan Erdoğan liderliğinde şekillenen, kaliteli malzeme kullanımı ve uzman ekipleriyle sektörde fark yaratan köklü bir markadır. Estetik ve fonksiyonelliği bir araya getiren özgün tasarım anlayışımızla, uzun vadeli değer sağlayan yaşam alanları sunuyoruz.</p>
          </motion.div>
