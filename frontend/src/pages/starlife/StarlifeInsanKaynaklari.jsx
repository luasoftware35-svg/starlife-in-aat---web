...
export default function StarlifeInsanKaynaklari() {
  ...
  return (
    <div className="bg-white text-ink min-h-screen">
      ...
      <PageHero title="İnsan Kaynakları" breadcrumb={[{ label: 'Anasayfa', href: '/starlife-insaat' }, { label: 'Kurumsal', href: '/starlife-insaat/kurumsal/hakkimizda' }, { label: 'İ.K.' }]} image="https://images.pexels.com/photos/6082416/pexels-photo-6082416.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=900&w=1600" />
