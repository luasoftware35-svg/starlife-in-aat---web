      ...
      <div className="max-w-[1400px] mx-auto grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-12 lg:gap-10">
        <div className="sm:col-span-2 lg:col-span-1">
          <Link to="/" className="inline-flex items-end gap-2">
            <span className="font-black text-2xl tracking-[0.2em] uppercase leading-none">
              ...
              <span className="text-charcoal">LİFE</span>
            </span>
            <span className="text-charcoal/45 font-light text-[10px] tracking-[0.4em] leading-none mb-[3px]">İNŞAAT</span>
          </Link>
          <p className="text-charcoal/55 text-[13px] mt-5 max-w-xs leading-[1.75] font-light">
        ...
        <div>
          ...
          <ul className="space-y-3.5">
            <li><Link to="/" className="text-charcoal/65 text-[14px] font-light hover:text-pomegranate hover:translate-x-1 transition-all inline-block">Anasayfa</Link></li>
            <li><Link to="/kurumsal/hakkimizda" className="text-charcoal/65 text-[14px] font-light hover:text-pomegranate hover:translate-x-1 transition-all inline-block">Hakkımızda</Link></li>
            <li><Link to="/blog" className="text-charcoal/65 text-[14px] font-light hover:text-pomegranate hover:translate-x-1 transition-all inline-block">Bizden Haberler</Link></li>
            <li><Link to="/iletisim" className="text-charcoal/65 text-[14px] font-light hover:text-pomegranate hover:translate-x-1 transition-all inline-block">İletişim</Link></li>
          </ul>
        </div>
